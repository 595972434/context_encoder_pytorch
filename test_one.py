...
input_cropped.data[:,0,int(opt.imageSize/4)+int(opt.overlapPred):int(opt.imageSize/4)+int(opt.imageSize/2)-int(opt.overlapPred),int(opt.imageSize/4)+int(opt.overlapPred):int(opt.imageSize/4)+int(opt.imageSize/2)-int(opt.overlapPred)] = 2*117.0/255.0 - 1.0
input_cropped.data[:,1,int(opt.imageSize/4)+int(opt.overlapPred):int(opt.imageSize/4)+int(opt.imageSize/2)-int(opt.overlapPred),int(opt.imageSize/4)+int(opt.overlapPred):int(opt.imageSize/4)+int(opt.imageSize/2)-int(opt.overlapPred)] = 2*104.0/255.0 - 1.0
input_cropped.data[:,2,int(opt.imageSize/4)+int(opt.overlapPred):int(opt.imageSize/4)+int(opt.imageSize/2)-int(opt.overlapPred),int(opt.imageSize/4)+int(opt.overlapPred):int(opt.imageSize/4)+int(opt.imageSize/2)-int(opt.overlapPred)] = 2*123.0/255.0 - 1.0
